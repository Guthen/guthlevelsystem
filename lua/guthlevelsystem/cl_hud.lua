...
hook.Add( "HUDPaintBackground", "LEVELSYSTEM:HUD", function()
    ...
    local lvl = LEVELSYSTEM.HUDTextLVL .. string.format( "%d", ply:GetNWInt( "LEVELSYSTEM:LVL", 0 ) )
    local xp = LEVELSYSTEM.HUDLVLPercentage and LEVELSYSTEM.HUDTextXP .. string.format( "%d", _xp/ply:GetNWInt( "LEVELSYSTEM:NXP", 0 )*100 ) .. "%"
               or LEVELSYSTEM.HUDTextXP .. string.format( "%d/%d", _xp, ply:GetNWInt( "LEVELSYSTEM:NXP", 0 ) )
